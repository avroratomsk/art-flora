(() => {
    ...
    function initSliders() {
        if (document.querySelector(".index-slider__slider")) new swiper_core_Swiper(".index-slider__slider", {
        ...
        if (document.querySelector(".section__slider")) new swiper_core_Swiper(".section__slider", {
        ...
        if (document.querySelector(".product__slider")) new swiper_core_Swiper(".product__slider", {
            ...
            loop: true,
            thumbs: {
                swiper: ".product-thumb__slider"
            },
            on: {}
        });
        if (document.querySelector(".product-thumb__slider")) new swiper_core_Swiper(".product-thumb__slider", {
            modules: [ Navigation, Pagination, Autoplay, Thumb ],
            observer: true,
            observeParents: true,
            slidesPerView: 3,
    ...
    if (filterCatalogItem) filterCatalogItem.forEach((item => {
        item.addEventListener("click", (function(e) {
